class words:
    def __init__(self):
        self.easywords = ["bat", "rat", "cat", "dog", "big", "hello", "word", "easy", "phone", "man", "woman", "book", "door", "wind", "tree", "hot", "mouse", "cake", "coffee", "eat", "plate", "bird", "bag"]

        self.mediumwords = ["frame", "computer", "helmet", "keyboard", "table", "apply", "world", "wallpaper", "notebook", "ocean", "waves", "handle", "chess", "calendar", "binder", "heater", "light", "knife", "click", "construction", "pencil", "heron", "text", "agenda", "clock", "terminal", "screen", "liquid", "crystal"]
